...
#              ws.select_largest().add_to_solution()
#              ws.select_largest().add_to_solution()))
#
# or, even better:
#
...
grammar.add_rule('STATE', 'ws',                   None,                     10.0)
grammar.add_rule('STATE', 'if_',                  ['BOOL','STATE','STATE'], 1.0)
grammar.add_rule('STATE', 'recurse_',             ['STATE'],                1.0)
grammar.add_rule('STATE', '%s.select_largest()',  ['STATE'],                1.0)
grammar.add_rule('STATE', '%s.add_to_solution()', ['STATE'],                1.0)

grammar.add_rule('BOOL',  '%s.started()',          ['STATE'],                1.0)
